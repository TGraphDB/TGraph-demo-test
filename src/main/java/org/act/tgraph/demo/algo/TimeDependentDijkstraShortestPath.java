 ...
 */
public class TimeDependentDijkstraShortestPath {
    ...
    public TimeDependentDijkstraShortestPath(GraphDatabaseService db, Logger logger){
        this.db = db;
        this.logger = logger;
    }
    public static void main(String[] args){
        Logger logger = LoggerFactory.getLogger(TimeDependentDijkstraShortestPath.class);
...
//                        logger.info(r.getId()+" "+g);
     ...
     */
    private void initAlgo(final long from, long to, final int t0, final AlgoHookAction hook) {
        new TransactionWrapper(){
            @Override
            public void runInTransaction() {
                long nodeCount=0;
