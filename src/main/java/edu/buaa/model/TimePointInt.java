...
public class TimePointInt implements Comparable<TimePointInt>
{
    ...
    public static final TimePointInt Now = new TimePointInt(true){
        ...
        @Override public TimePointInt pre() { throw new UnsupportedOperationException("should not call pre on TimePoint.NOW"); }
        @Override public TimePointInt next() { throw new UnsupportedOperationException("should not call next on TimePoint.NOW"); }
    ...
    public static final TimePointInt Init = new TimePointInt(false){
        ...
        @Override public TimePointInt pre() { throw new UnsupportedOperationException("should not call pre on TimePoint.INIT"); }
        @Override public TimePointInt next() { throw new UnsupportedOperationException("should not call next on TimePoint.INIT"); }
