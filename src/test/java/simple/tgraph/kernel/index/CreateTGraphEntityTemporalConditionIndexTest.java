...
public class CreateTGraphEntityTemporalConditionIndexTest {
...
//    private static String endTime = Helper.mustEnv("TEMPORAL_DATA_END");
    ...
    public static void init() throws IOException, ExecutionException, InterruptedException {
        ...
        post = new BenchmarkTxResultProcessor("TGraph(CreateTGraphEntityTemporalConditionIndex)", Helper.codeGitVersion());
