package org.act.temporal.test2.singleThread;
...
public class GetTest {
    ...
    private OperationProxy temporalDB=new TemporalSimulationProxy();
...
//        tx = db.beginTx();
    ...
    public void simple(){
        ...
        try(Transaction tx = db.beginTx()){
            ...
            logger.info("rid:{}",relationship.getId());System.out.println("aaaaa");
            db.getRelationshipById(0);System.out.println("bbbbb");
            node.delete();System.out.println("cccc");
            node1.setProperty("abc","123");System.out.println("ddddd");
            tx.success();
        }
    }
